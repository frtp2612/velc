...
const steps: VStep[] = [
	{
		title: "step 1",
		component: Step1,
		completionCondition: () => state.value.step1Cleared,
	},
	{
		title: "step 2",
		component: Step2,
		completionCondition: () => state.value.step2Cleared,
	},
	{
		title: "step 3",
		component: Step3,
		completionCondition: () => state.value.name !== "",
	},
	{
		title: "step 4",
		component: Step4,
		completionCondition: () => state.value.age > 18,
