<template>
	<VPopover class="relative" ref="popover">
		...
		<template #content>
			<div class="grid color-picker-grid gap-8 w-min">
				<div
				...
				<div class="flex gap-4 col-span-2 items-center">
					<VButton :type="VButtonTypes.PRIMARY">Copy</VButton>
					<VButton :on-click="popover?.close">Close</VButton>
				</div>
			</div>
		</template>
	</VPopover>
	<div class="flex w-min"></div>
</template>
