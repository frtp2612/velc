<template>
  <div class="flex flex-col gap-4 min-h-0 min-w-0 h-full w-full" ref="list">
    ...
    >
      ...
      <VirtualScroller
        :item-height="32"
        :items="data"
        :scrollable-container="listContainer!"
...
import { TranslationType, VDataType } from "../../enums/index";
...
import { VDataColumn, VDataRow } from "../VDataGrid/types";
