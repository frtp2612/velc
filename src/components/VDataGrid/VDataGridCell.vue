<template>
  <div
    ...
    class="flex leading-[31px] border-b border-r-color-bg-100 border-r outline-0 p-[1px] relative max-w-full"
  ...
  >
    ...
    <VLabel
      ...
      :class="[
        editable ? 'hover:outline outline-color-secondary-500 outline-1' : '',
      ]"
      v-else
    >
      {{ formattedValue }}
