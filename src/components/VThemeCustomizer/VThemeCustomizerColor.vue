<template>
  <div
    class="flex gap-4 p-2 h-full border hover:border-color-primary cursor-pointer rounded-lg"
    :class="[
      active
        ? 'bg-color-secondary-50 border-color-secondary-100'
        : 'bg-color-bg-50 border-transparent',
    ]"
  >
