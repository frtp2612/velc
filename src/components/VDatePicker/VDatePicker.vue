			...
			<template v-slot="{ events, attributes }">
				...
				>
					...
					<font-awesome-icon
						...
						class="w-5 aspect-square absolute top-1/2 -translate-y-1/2 left-0 px-2 text-color-text-300 group-hover:text-color-text"
					/>

					<font-awesome-icon
						icon="fa-xmark"
						class="cursor-pointer w-5 aspect-square absolute top-1/2 -translate-y-1/2 right-0 p-2 text-color-text-300 hover:text-color-text"
