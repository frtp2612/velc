...
const rules: Rule[] = [
	{
		id: "tags",
		lookFor: /(&lt;[\/]?)([a-z]+)([a-z|="{}| ]*&gt;)/gm,
		substituteWith: () => `$1<p class='font-semibold text-theme-tag'>$2</p>$3`,
	},
	{
		id: "component-tags",
		lookFor: /(&lt;[\/]?)([A-Z]+[a-z]+)([a-zA-Z|\-:="{}| ]*[\/]?&gt;)/gm,
		substituteWith: () =>
			`$1<p class='font-semibold text-theme-component-tag'>$2</p>$3`,
	},
	{
		id: "import",
	...
	},
	{
		id: "language-syntax",
		lookFor: /Array/gm,
		substituteWith: () => `<p class='font-semibold text-theme-tag-200'>$&</p>`,
	},
	{
		id: "vue-syntax",
		lookFor: /ref|v-model/gm,
		substituteWith: () => `<p class='font-semibold text-theme-tag-300'>$&</p>`,
	},
];
