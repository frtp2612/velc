...
const colors = {
	...
	["color-success"]: {
		...
		50: generateColorClass("color-success-50"),
		100: generateColorClass("color-success-100"),
		200: generateColorClass("color-success-200"),
		300: generateColorClass("color-success-300"),
		400: generateColorClass("color-success-400"),
		500: generateColorClass("color-success-500"),
		600: generateColorClass("color-success-600"),
		700: generateColorClass("color-success-700"),
		800: generateColorClass("color-success-800"),
		900: generateColorClass("color-success-900"),
	},
	["color-error"]: {
		DEFAULT: generateColorClass("color-error"),
		50: generateColorClass("color-error-50"),
		100: generateColorClass("color-error-100"),
		200: generateColorClass("color-error-200"),
		300: generateColorClass("color-error-300"),
		400: generateColorClass("color-error-400"),
		500: generateColorClass("color-error-500"),
		600: generateColorClass("color-error-600"),
		700: generateColorClass("color-error-700"),
		800: generateColorClass("color-error-800"),
		900: generateColorClass("color-error-900"),
	},
	["color-alert"]: {
		DEFAULT: generateColorClass("color-alert"),
		50: generateColorClass("color-alert-50"),
		100: generateColorClass("color-alert-100"),
		200: generateColorClass("color-alert-200"),
		300: generateColorClass("color-alert-300"),
		400: generateColorClass("color-alert-400"),
		500: generateColorClass("color-alert-500"),
		600: generateColorClass("color-alert-600"),
		700: generateColorClass("color-alert-700"),
		800: generateColorClass("color-alert-800"),
		900: generateColorClass("color-alert-900"),
	},
	["color-text"]: {
